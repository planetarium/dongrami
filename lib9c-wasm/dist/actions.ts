...
import { Address, Guid, Currency, serializeObjectAsDotnet } from "./utils";
function buildActionWrapper(typeId: string, plainValue: object): Uint8Array {
    return dotnet.Lib9c.Wasm.buildAction(typeId, serializeObjectAsDotnet(plainValue) as any);
}
...
export function battle_arena9(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];runeInfos: {slotIndex: number;runeId: number;}[];}): Uint8Array {
    return buildActionWrapper("battle_arena9", plainValue as any);
}
export function battle_arena(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_arena", plainValue as any);
}
export function battle_arena2(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_arena2", plainValue as any);
}
export function battle_arena3(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_arena3", plainValue as any);
}
export function battle_arena4(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_arena4", plainValue as any);
}
export function battle_arena5(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_arena5", plainValue as any);
}
export function battle_arena6(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_arena6", plainValue as any);
}
export function battle_arena7(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];runeInfos: {slotIndex: number;runeId: number;}[];}): Uint8Array {
    return buildActionWrapper("battle_arena7", plainValue as any);
}
export function battle_arena8(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;championshipId: number;round: number;ticket: number;costumes: Guid[];equipments: Guid[];runeInfos: {slotIndex: number;runeId: number;}[];}): Uint8Array {
    return buildActionWrapper("battle_arena8", plainValue as any);
}
export function battle_grand_finale2(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;grandFinaleId: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_grand_finale2", plainValue as any);
}
export function battle_grand_finale(plainValue: {myAvatarAddress: Address;enemyAvatarAddress: Address;grandFinaleId: number;costumes: Guid[];equipments: Guid[];}): Uint8Array {
    return buildActionWrapper("battle_grand_finale", plainValue as any);
}
...
export function buy(plainValue: {buyerAvatarAddress: Address;sellerAgentAddress: Address;sellerAvatarAddress: Address;productId: Guid;}): Uint8Array {
    return buildActionWrapper("buy", plainValue as any);
}
export function buy10(plainValue: {purchaseInfos: {orderId: Guid;tradableId: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy10", plainValue as any);
}
export function buy11(plainValue: {purchaseInfos: {orderId: Guid;tradableId: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy11", plainValue as any);
}
export function buy2(plainValue: {buyerAvatarAddress: Address;sellerAgentAddress: Address;sellerAvatarAddress: Address;productId: Guid;}): Uint8Array {
    return buildActionWrapper("buy2", plainValue as any);
}
export function buy3(plainValue: {buyerAvatarAddress: Address;sellerAgentAddress: Address;sellerAvatarAddress: Address;productId: Guid;}): Uint8Array {
    return buildActionWrapper("buy3", plainValue as any);
}
export function buy4(plainValue: {buyerAvatarAddress: Address;sellerAgentAddress: Address;sellerAvatarAddress: Address;productId: Guid;}): Uint8Array {
    return buildActionWrapper("buy4", plainValue as any);
}
export function buy5(plainValue: {purchaseInfos: {id: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy5", plainValue as any);
}
export function buy6(plainValue: {purchaseInfos: {id: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy6", plainValue as any);
}
export function buy7(plainValue: {purchaseInfos: {id: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy7", plainValue as any);
}
export function buy8(plainValue: {purchaseInfos: {orderId: Guid;tradableId: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy8", plainValue as any);
}
export function buy9(plainValue: {purchaseInfos: {orderId: Guid;tradableId: Guid;agentAddress: Address;avatarAddress: Address;type: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";itemPrice: {currency: Currency;sign: number;majorUnit: string;minorUnit: string;};}[];buyerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("buy9", plainValue as any);
}
export function buy_multiple(plainValue: {buyerAvatarAddress: Address;purchaseInfos: {productId: Guid;sellerAgentAddress: Address;sellerAvatarAddress: Address;}[];}): Uint8Array {
    return buildActionWrapper("buy_multiple", plainValue as any);
}
...
export function combination_equipment16(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;payByCrystal: boolean;useHammerPoint: boolean;petId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment16", plainValue as any);
}
export function combination_equipment(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment", plainValue as any);
}
export function combination_equipment10(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment10", plainValue as any);
}
export function combination_equipment11(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment11", plainValue as any);
}
export function combination_equipment12(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;payByCrystal: boolean;}): Uint8Array {
    return buildActionWrapper("combination_equipment12", plainValue as any);
}
export function combination_equipment13(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;payByCrystal: boolean;useHammerPoint: boolean;}): Uint8Array {
    return buildActionWrapper("combination_equipment13", plainValue as any);
}
export function combination_equipment14(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;payByCrystal: boolean;useHammerPoint: boolean;}): Uint8Array {
    return buildActionWrapper("combination_equipment14", plainValue as any);
}
export function combination_equipment15(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;payByCrystal: boolean;useHammerPoint: boolean;}): Uint8Array {
    return buildActionWrapper("combination_equipment15", plainValue as any);
}
export function combination_equipment2(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment2", plainValue as any);
}
export function combination_equipment3(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment3", plainValue as any);
}
export function combination_equipment4(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment4", plainValue as any);
}
export function combination_equipment5(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment5", plainValue as any);
}
export function combination_equipment6(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment6", plainValue as any);
}
export function combination_equipment7(plainValue: {AvatarAddress: Address;RecipeId: number;SlotIndex: number;SubRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment7", plainValue as any);
}
export function combination_equipment8(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;}): Uint8Array {
    return buildActionWrapper("combination_equipment8", plainValue as any);
}
export function combination_equipment9(plainValue: {avatarAddress: Address;slotIndex: number;recipeId: number;subRecipeId: number| null;}): Uint8Array {
...
export function create_pending_activation(plainValue: {activationKey: {address: Address;Nonce: Uint8Array;PublicKey: {publicKey: number[];};};}): Uint8Array {
...
export function daily_reward2(plainValue: {avatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("daily_reward2", plainValue as any);
}
export function daily_reward3(plainValue: {avatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("daily_reward3", plainValue as any);
}
export function daily_reward4(plainValue: {avatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("daily_reward4", plainValue as any);
}
...
export function hack_and_slash20(plainValue: {Costumes: Guid[];Equipments: Guid[];Foods: Guid[];RuneInfos: {slotIndex: number;runeId: number;}[];WorldId: number;StageId: number;StageBuffId: number| null;AvatarAddress: Address;TotalPlayCount: number;ApStoneCount: number;}): Uint8Array {
    return buildActionWrapper("hack_and_slash20", plainValue as any);
}
export function hack_and_slash(plainValue: {costumes: number[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash", plainValue as any);
}
...
export function hack_and_slash14(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;stageBuffId: number| null;avatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash14", plainValue as any);
}
export function hack_and_slash15(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;stageBuffId: number| null;avatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash15", plainValue as any);
}
export function hack_and_slash16(plainValue: {Costumes: Guid[];Equipments: Guid[];Foods: Guid[];WorldId: number;StageId: number;StageBuffId: number| null;AvatarAddress: Address;PlayCount: number;}): Uint8Array {
    return buildActionWrapper("hack_and_slash16", plainValue as any);
}
export function hack_and_slash17(plainValue: {Costumes: Guid[];Equipments: Guid[];Foods: Guid[];WorldId: number;StageId: number;StageBuffId: number| null;AvatarAddress: Address;PlayCount: number;}): Uint8Array {
    return buildActionWrapper("hack_and_slash17", plainValue as any);
}
export function hack_and_slash18(plainValue: {Costumes: Guid[];Equipments: Guid[];Foods: Guid[];WorldId: number;StageId: number;StageBuffId: number| null;AvatarAddress: Address;PlayCount: number;}): Uint8Array {
    return buildActionWrapper("hack_and_slash18", plainValue as any);
}
export function hack_and_slash19(plainValue: {Costumes: Guid[];Equipments: Guid[];Foods: Guid[];RuneInfos: {slotIndex: number;runeId: number;}[];WorldId: number;StageId: number;StageBuffId: number| null;AvatarAddress: Address;PlayCount: number;}): Uint8Array {
    return buildActionWrapper("hack_and_slash19", plainValue as any);
}
export function hack_and_slash2(plainValue: {costumes: number[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash2", plainValue as any);
}
export function hack_and_slash3(plainValue: {costumes: number[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash3", plainValue as any);
}
export function hack_and_slash4(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash4", plainValue as any);
}
export function hack_and_slash5(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash5", plainValue as any);
}
export function hack_and_slash6(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("hack_and_slash6", plainValue as any);
}
...
export function migration_legacy_shop2(plainValue: {AvatarAddressesHex: string[];}): Uint8Array {
    return buildActionWrapper("migration_legacy_shop2", plainValue as any);
}
export function migration_legacy_shop(plainValue: {AvatarAddressesHex: string[];}): Uint8Array {
...
export function mimisbrunnr_battle(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("mimisbrunnr_battle", plainValue as any);
}
...
export function mimisbrunnr_battle2(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("mimisbrunnr_battle2", plainValue as any);
}
export function mimisbrunnr_battle3(plainValue: {costumes: Guid[];equipments: Guid[];foods: Guid[];worldId: number;stageId: number;avatarAddress: Address;WeeklyArenaAddress: Address;RankingMapAddress: Address;}): Uint8Array {
    return buildActionWrapper("mimisbrunnr_battle3", plainValue as any);
}
...
export function ranking_battle12(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle12", plainValue as any);
}
export function ranking_battle(plainValue: {AvatarAddress: Address;EnemyAddress: Address;WeeklyArenaAddress: Address;costumeIds: number[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle", plainValue as any);
}
export function ranking_battle10(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle10", plainValue as any);
}
export function ranking_battle11(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle11", plainValue as any);
}
export function ranking_battle2(plainValue: {AvatarAddress: Address;EnemyAddress: Address;WeeklyArenaAddress: Address;costumeIds: number[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle2", plainValue as any);
}
export function ranking_battle3(plainValue: {AvatarAddress: Address;EnemyAddress: Address;WeeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle3", plainValue as any);
}
export function ranking_battle4(plainValue: {AvatarAddress: Address;EnemyAddress: Address;WeeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle4", plainValue as any);
}
export function ranking_battle5(plainValue: {AvatarAddress: Address;EnemyAddress: Address;WeeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle5", plainValue as any);
}
export function ranking_battle6(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle6", plainValue as any);
}
export function ranking_battle7(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle7", plainValue as any);
}
export function ranking_battle8(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle8", plainValue as any);
}
export function ranking_battle9(plainValue: {avatarAddress: Address;enemyAddress: Address;weeklyArenaAddress: Address;costumeIds: Guid[];equipmentIds: Guid[];consumableIds: Guid[];}): Uint8Array {
    return buildActionWrapper("ranking_battle9", plainValue as any);
}
...
export function rapid_combination8(plainValue: {avatarAddress: Address;slotIndex: number;AvatarAddress: Address;SlotIndex: number;}): Uint8Array {
...
export function sell_cancellation(plainValue: {productId: Guid;sellerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("sell_cancellation", plainValue as any);
}
export function sell_cancellation2(plainValue: {productId: Guid;sellerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("sell_cancellation2", plainValue as any);
}
export function sell_cancellation3(plainValue: {productId: Guid;sellerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("sell_cancellation3", plainValue as any);
}
export function sell_cancellation4(plainValue: {productId: Guid;sellerAvatarAddress: Address;}): Uint8Array {
    return buildActionWrapper("sell_cancellation4", plainValue as any);
}
export function sell_cancellation5(plainValue: {productId: Guid;sellerAvatarAddress: Address;itemSubType: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";}): Uint8Array {
    return buildActionWrapper("sell_cancellation5", plainValue as any);
}
export function sell_cancellation6(plainValue: {productId: Guid;sellerAvatarAddress: Address;itemSubType: "Food" | "FullCostume" | "HairCostume" | "EarCostume" | "EyeCostume" | "TailCostume" | "Weapon" | "Armor" | "Belt" | "Necklace" | "Ring" | "EquipmentMaterial" | "FoodMaterial" | "MonsterPart" | "NormalMaterial" | "Hourglass" | "ApStone" | "Chest" | "Title";}): Uint8Array {
    return buildActionWrapper("sell_cancellation6", plainValue as any);
}
